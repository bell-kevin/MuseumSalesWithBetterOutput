 ...
 */
package museumsaleswithbetteroutput;
 ...
 * @author 4800590195
 */
public class MuseumSalesWithBetterOutput {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Science Museum Sales Part 3 by Kevin Bell");
        ...
        subTotalPrice = (smallShirts * smallShirtPrice) + (mediumShirts * mediumShirtPrice)
                + (largeShirts * largeShirtPrice) + (extraLargeShirts * extraLargeShirtPrice) + (pencils * pencilPrice) + (erasers * eraserPrice)
        ...
        //output
        System.out.printf("Total tour cost = $%,.2f", totalTourPrice);
        System.out.println("");
    }
}
